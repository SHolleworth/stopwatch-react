...
const Laps = ({ started, elapsedTime, lapTimes }) => {
    ...
    const renderEmptyLaps = () => {
        ...
        return new Array(length).fill(0, 0, length).map((el, index) => react_1.default.createElement("div", { className: "lap", key: index }));
    };
    const renderLaps = () => {
        return started
            ? [elapsedTime, ...lapTimes].map((lapTime, index) => {
                const lapNumber = lapTimes.length - index + 1;
                return (react_1.default.createElement("div", { className: "lap " + addColorClass(index - 1), key: lapNumber },
                    react_1.default.createElement("p", null, "Lap " + lapNumber),
                    react_1.default.createElement("p", null, (0, utility_1.renderTime)(lapTime))));
            })
            : null;
    };
    return (react_1.default.createElement("div", { className: "laps-box" },
        renderLaps(),
        renderEmptyLaps()));
};
