...
const App = () => {
    ...
    return (react_1.default.createElement("div", { className: "App" },
        react_1.default.createElement("div", { className: "background" },
            ...
            react_1.default.createElement(Buttons_1.default, { running: running, startTimer: startTimer, stopTimer: stopTimer, resetTimer: resetTimer, makeLap: makeLap }),
            react_1.default.createElement(Laps_1.default, { started: mainTimer.elapsedTime !== 0, elapsedTime: getActiveLapTime(), lapTimes: lapData.times }))));
};
exports.default = App;
